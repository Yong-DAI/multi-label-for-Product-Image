...
#dataname = ['glasses','gua_earphone','handband','hou_earphone' ,'ru_earphone','sai_earphone','tou_earphone','watch']
#dataname = ['glasses','gua_earphone','handband','hou_earphone' ,'ru_earphone','sai_earphone','tou_earphone','watch']
#dataname = ['interphone','mobile','MP4','radio' ]
dataname = ['front-2' ]
for name in dataname:
    ...
    parser.add_argument('-i', type=str, help='Folder of Images to Process.', default = '/home/dy/dy/smart_design/%s'%name)
    
    
    parser.add_argument('-t', type=int, help='Tolerance of similarity detection, higher is stricter.', default=5)
    #This is the severity of comparision between Images
    args = vars(parser.parse_args())
    ImageFolder = args['i']
    tol = args['t']
    
    COMPARE_PERCENTAGE = tol     #####  default is 23
    
    outdir = str(str(os.path.splitext(ImageFolder)[-1]) + "Duplicates_%s"%name);
